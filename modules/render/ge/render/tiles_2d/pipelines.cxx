...
module tiles_2d.pipelines;

import tiles_2d.vertex_description;
...
namespace ge::tiles
{
    namespace
    {
        ...
        vk::UniquePipeline new_tiles_pipeline
        (
    ...
    )
    {
        ...
        assert(device_data.enabled_features.test(DeviceFeatures::WideLines)); // for vk::PolygonMode::eLine
