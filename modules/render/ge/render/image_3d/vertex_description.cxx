...
module image_3d.vertex_description;

import exception;
import texture_coords;
import world_3d_coords;
...
namespace ge::image3d
{
    ...
    {
        constexpr uint32_t vertex_offset = offsetof(World3dCoords, coords);
        constexpr uint32_t tex_coord_offset = sizeof(World3dCoords);
        ...
        const std::array result
        {
            vk::VertexInputAttributeDescription{}
                ...
                .setFormat(vk::Format::eR32G32B32Sfloat) // 3 float'а по 32 бит каждый
